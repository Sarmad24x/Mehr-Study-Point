        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                _buildLegendItem(Colors.blue.shade600, 'Reserved (${stats.reservedSeats})'),
                const SizedBox(width: 24),
                _buildLegendItem(Colors.green.shade400, 'Available (${stats.availableSeats})'),
              ],
            )
          ],
        ),
            ...
            SizedBox(
              ...
              child: BarChart(
                BarChartData(
                  ...
                  maxY: (stats.totalFeesCollectedThisMonth > stats.pendingFeesAmount 
                      ? stats.totalFeesCollectedThisMonth 
                      : stats.pendingFeesAmount) * 1.2,
                  barGroups: [
                    BarChartGroupData(x: 0, barRods: [
                      BarChartRodData(
                        toY: stats.totalFeesCollectedThisMonth,
                    ...
                    bottomTitles: AxisTitles(
                      sideTitles: SideTitles(
                        ...
                        getTitlesWidget: (value, meta) {
                          if (value == 0) return const Text('Collected', style: TextStyle(fontSize: 10));
                          if (value == 1) return const Text('Pending', style: TextStyle(fontSize: 10));
                          return const SizedBox.shrink();
                        },
                      ),
                    ),
